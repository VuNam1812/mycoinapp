...
export const Navbar = (props) => {
  const { myWallet, auth } = useContext(authContext);
  ...
  const handleBuyCoin = async () => {
    ...
    await axios.post(
      "https://back-end-coin.herokuapp.com/transactions/buycoin",
      {
    ...
    <div className={`navbar row ${props.className}`}>
      <div className="navbar__container">
        <Link to="/" className="navbar__container__logo">
          <img src="https://mycoinblockchain.s3.sa-east-1.amazonaws.com/img/short-hand-logo-web.5d962d4e.png"></img>
        </Link>
            ...
            <li>
              <div className="buy-MC" onClick={handleBuyMC}>
                <div className="buy-MC__image">
                  <img src="https://mycoinblockchain.s3.sa-east-1.amazonaws.com/img/buy-eth.75fcd9b0.svg"></img>
                </div>
